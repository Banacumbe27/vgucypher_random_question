...
What does IP stand for in computer networking?,"Trong mạng máy tính, IP là viết tắt của cụm từ nào?",,short_answer,,,,,,,,,Internet Protocol,Internet Protocol,true
...
// Cryptic & Nuanced Hints Map for Questions (Bilingual)
const QUESTION_HINTS = {
    1: { en: "Every orchestra obeys a single conductor at the heart of the silicon.", vi: "Mọi dàn nhạc đều tuân theo một vị nhạc trưởng duy nhất ở trung tâm thạch anh." },
    2: { en: "Like a desk surface during work hours: wide open now, but cleared when night falls.", vi: "Như mặt bàn làm việc ban ngày: bày biện đủ thứ khi làm, nhưng trống trơn khi màn đêm buông xuống." },
    3: { en: "Count the legs of an arachnid, or double a quartet.", vi: "Bằng số chân của loài nhện, hoặc gấp đôi một bộ tứ." },
    4: { en: "Words are for human tongues; coordinates are for machines. Someone must bridge the two.", vi: "Tên gọi dành cho trí nhớ con người; tọa độ dành cho máy móc. Cần một kẻ dẫn đường ở giữa." },
    5: { en: "Look through the glass frame to let the light into Redmond.", vi: "Mở khung kính để nhìn ra thế giới bên ngoài ngôi nhà ở Redmond." },
    6: { en: "No spinning platters, no sweeping needles—silent gates of trapped charge.", vi: "Không đĩa quay, không đầu từ quét—chỉ có sự im lặng của những cổng điện tử." },
    7: { en: "Light and darkness, presence and void—the minimal alphabet of truth.", vi: "Bật và tắt, có và không—bảng chữ cái tối giản nhất của vũ trụ số." },
    8: { en: "Countable without fracture; three letters of wholeness.", vi: "Đếm trọn vẹn không mảnh vỡ; tên gọi 3 chữ cái đại diện cho sự nguyên vẹn." },
    9: { en: "The tic-tac-toe grid, where the interpreter chooses not to look.", vi: "Bàn cờ ca-rô bốn nét, nơi trình thông dịch làm ngơ không đọc." },
    10: { en: "Clothes make the man; quotation marks make the text.", vi: "Chiếc áo khoác ngoặc kép biến con số thành lời nói." },
    11: { en: "A four and a two whisper together in the dark.", vi: "Bốn và hai cùng thì thầm trong bóng tối." },
    12: { en: "The engraved stone keeps what the running stream forgets.", vi: "Phiến đá khắc giữ lại những gì dòng suối đã quên khi ngừng chảy." },
    13: { en: "The patron who orders from the kitchen menu.", vi: "Vị thực khách gọi món từ nhà bếp." },
    14: { en: "Four islands, each bounded by the limits of a single byte.", vi: "Bốn hòn đảo, mỗi nơi không vượt quá giới hạn của một byte." },
    15: { en: "The lucky prime that marks the days of a week.", vi: "Con số may mắn tương ứng với số ngày trong một tuần." },
    16: { en: "The multiplication star shines before the plus sign rises.", vi: "Dấu nhân tỏa sáng trước khi dấu cộng kịp thức giấc." },
    17: { en: "Mirror of reality first; generous optimism second.", vi: "Chiếc gương đảo ngược trước; sự dung nạp hào phóng theo sau." },
    18: { en: "The floor only catches the integer, letting the remainder fall into the abyss.", vi: "Mặt sàn chỉ đỡ lấy phần trọn vẹn, để mảnh vỡ rơi vào khoảng không." },
    19: { en: "The first step is zero; who stands upon the next?", vi: "Bậc thang khởi đầu là số không; ai đang đứng ở bậc tiếp theo?" },
    20: { en: "A triangular sum of three small steps, stopping before four arrives.", vi: "Bậc tam cấp của ba bước chân, dừng lại ngay trước ngưỡng cửa số bốn." },
    21: { en: "Two names for one house; repaint the door and both inhabitants see the change.", vi: "Hai cái tên cùng chung một mái nhà; đổi màu cánh cửa thì ai ngắm cũng thấy khác." },
    22: { en: "A frozen inscription does not budge when a new parchment is penned.", vi: "Tấm bia đá không bao giờ thay đổi chỉ vì ai đó viết thêm một trang giấy mới." },
    23: { en: "Gravity pulls always downward toward the deeper cold.", vi: "Trọng lực luôn kéo mọi thứ chìm sâu hơn về phía đáy vực lạnh lẽo." },
    24: { en: "Work done in silence without handing back the fruit leaves empty hands.", vi: "Lao động miệt mài nhưng không trao tay thành quả sẽ để lại sự hư vô." },
    25: { en: "Types divide the first pair; mathematical identity bridges the second.", vi: "Bản chất khác biệt chia rẽ cặp đầu; giá trị số học hòa giải cặp sau." },
    26: { en: "One byte falls short by 44; ascend to the next power.", vi: "Một byte hụt mất một đoạn; phải leo lên tầng lũy thừa kế tiếp." },
    27: { en: "An odometer that spills over its ceiling and greets the dawn anew.", vi: "Đồng hồ đo chạm trần giới hạn rồi quay trở về với vạch xuất phát." },
    28: { en: "Between one and four, how many can be halved cleanly?", vi: "Từ một tới bốn, có bao nhiêu con số có thể chia đôi êm đẹp?" },
    29: { en: "An armored courier protects the envelope, but cannot vouch for the letter inside.", vi: "Chiếc hòm thư bọc thép bảo vệ bức thư trên đường đi, nhưng không chứng minh người gửi là người tốt." },
    30: { en: "Mind the uppercase 'B' and its eightfold multiplier.", vi: "Hãy lưu ý chữ 'B' viết hoa và cấp số nhân gấp tám lần." },
    31: { en: "Arbitrary reach, swift retrieval, and recalling what is active.", vi: "Tự do chạm tới bất kỳ điểm nào, không cần xếp hàng theo thứ tự." },
    32: { en: "A museum plaque: eyes may gaze upon it, but no chisel may alter the text.", vi: "Tấm bia đá trong bảo tàng: chỉ để chiêm ngưỡng, cấm dùng đục sửa đổi." },
    33: { en: "A century of keys, plus four modern additions.", vi: "Tròn một thế kỷ phím gõ, cộng thêm bốn phím dẫn lối của thời hiện đại." },
    ...
    35: { en: "The painter's palette that dresses the raw naked structure in style.", vi: "Bảng màu của họa sĩ khoác lên vẻ đẹp và hình thức cho bộ khung thô." },
    36: { en: "Think of snakes, coffee beans, single letters, and web scripts.", vi: "Nghĩ về loài rắn, hạt cà phê, chữ cái cổ điển, và linh hồn của các trang web." },
    37: { en: "One breathes in clouds near human thought; the other walks among bare copper wires.", vi: "Một tầng ngự trên mây gần với tiếng nói; một tầng bước đi trên dây đồng trần trụi." },
    38: { en: "The global web's foundational agreement on etiquette and addressing.", vi: "Bản quy ước về nghi thức và địa chỉ giao tiếp của mạng toàn cầu." },
    39: { en: "Gutenberg's legacy in five letters followed by parentheses.", vi: "Di sản của nghề in ấn gói gọn trong 5 chữ cái và đôi ngoặc tròn." },
    40: { en: "Named after George, who reduced philosophy to two states.", vi: "Mang tên nhà toán học George, người thu gọn triết lý thành hai trạng thái." },
    41: { en: "Unleash the number from its text cage, then add a trio.", vi: "Giải thoát con số khỏi lồng kính chuỗi, rồi cộng thêm một bộ ba." },
    42: { en: "A runner's cheer echoed three times without pause.", vi: "Tiếng reo hò xuất phát vang vọng ba lần liên tiếp không ngắt quãng." },
    43: { en: "Count the letters, but do not ignore the silent breath in between.", vi: "Đếm từng con chữ, nhưng đừng bỏ qua khoảng thở vô hình ở giữa." },
    44: { en: "Above the bar; the gatekeeper smiles and bids you proceed.", vi: "Vượt qua ngưỡng cửa; người gác cổng mỉm cười cho phép bạn bước tiếp." },
    45: { en: "Translating the entire novel in advance vs whisper-translating live sentence by sentence.", vi: "Dịch trọn vẹn cuốn sách trước khi in vs phiên dịch đuổi từng câu khi đang nói." },
    46: { en: "Even digits typed at the prompt are wrapped in a textual cocoon.", vi: "Dù bạn gõ những con số, chúng vẫn bị bọc trong chiếc kén văn bản." },
    47: { en: "Eight, four, and one answer the roll call; two stays silent.", vi: "Tám, bốn và một lên tiếng điểm danh; chỉ có hai là giữ im lặng." },
    48: { en: "Three groups of five take their leave; what orphan is left behind?", vi: "Ba nhóm năm người cùng rời đi; còn lại đứa trẻ bơ vơ nào phía sau?" },
    49: { en: "When an inquiry is made, this is the reply that journeys back.", vi: "Khi một câu hỏi được đặt ra, đây là tiếng vọng gửi lại." },
    50: { en: "The wheel turns until the boundary is met, then rests right upon it.", vi: "Bánh xe lăn cho tới khi chạm vách ngăn, rồi dừng lại ngay tại mốc đó." },
    51: { en: "Fractions in powers of ten do not fit cleanly into powers of two.", vi: "Các phân số hệ thập phân không thể xếp vừa khít vào các lũy thừa cơ số hai." },
    52: { en: "To the boolean eye, even the word for deception is something rather than nothing.", vi: "Dưới mắt nhìn chân lý, ngay cả chữ mang nghĩa sai lầm vẫn là sự tồn tại." },
    53: { en: "Oil and water cannot mix; the interpreter protests against incompatible species.", vi: "Dầu và nước không thể hòa tan; người gác cổng phản đối sự lai tạp giống loài." },
    54: { en: "Stepping beyond the edge of the map where no territory exists.", vi: "Bước chân quá đà ra khỏi mép bản đồ, nơi không còn lãnh thổ." },
    55: { en: "A photograph severed from the original remains unchanged when the copy is marked.", vi: "Tấm ảnh đã cắt rời bản gốc: vẽ thêm lên bản sao không làm mờ bản chính." },
    56: { en: "Carved in granite: to alter a single rune, you must chisel a brand new tablet.", vi: "Được khắc trên đá hoa cương: muốn đổi một chữ, phải tạc một phiến đá mới." },
    57: { en: "The action transforms the subject, but hands no prize to the caller.", vi: "Hành động biến đổi bên trong, nhưng trả về đôi bàn tay trắng cho kẻ gọi." },
    58: { en: "The journey is cut short before four, summing only the dawn steps.", vi: "Chuyến đi bị chặn đứng trước mốc bốn, chỉ gom lại những bước chân bình minh." },
    59: { en: "Losing the phonebook does not mean the telephone line has gone dead.", vi: "Đánh mất danh bạ không có nghĩa là đường dây điện thoại đã bị cắt đứt." },
    60: { en: "A hybrid journey: first translated into secret symbols, then performed by an actor.", vi: "Hành trình lai: trước tiên dịch sang mật mã trung gian, rồi để người diễn viên xướng âm." }
};
...
function checkDirectAnswerMatch(val, q) {
    ...
    for (const raw of rawList) {
        ...
        if (cleanHyphenNorm === 'internetprotocol') {
            accepted.add('internet protocol');
            accepted.add('internet-protocol');
            accepted.add('internetprotocol');
        }
